...
public class UpdateChecker {
	 ...
	 * 
	 * 
	 * pulled from SG, would need to be adapted
	 *
	 *
	 *
	 */
        ...
        try{
           ...
           // System.out.println(in[0]+b);
            if(b){
                ...
                player.sendMessage(ChatColor.DARK_BLUE+"--------------------------------------");
                Minigame.$("[Updates found!");

            }else{
            	Minigame.$("[SG][info]No updates found!");
            }   
        }catch(Exception e){
        	Minigame.$(Level.WARNING, "[SurvivalGames] could not check for updates.");
        }
    }
}